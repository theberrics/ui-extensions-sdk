...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dialogs = __webpack_require__(62);
	...
	function createWidgetAPI(channel, _ref) {
	  ...
	  return {
	    ...
	    dialogs: (0, _dialogs2.default)(channel)
	  };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FieldLocale = function () {
	  function FieldLocale(channel, fieldInfo) {
	    ...
	    this._valueSignal = new _signal.MemoizedSignal(this._value);
...
/***/ function(module, exports) {
	...
	var spaceMethods = ['getContentType', 'getEntry', 'getAsset', 'getPublishedEntries', 'getPublishedAssets', 'getContentTypes', 'getEntries', 'getAssets', 'createContentType', 'createEntry', 'createEntryWithId', 'createAsset', 'updateContentType', 'updateEntry', 'updateAsset', 'deleteContentType', 'deleteEntry', 'deleteAsset', 'publishEntry', 'publishAsset', 'unpublishEntry', 'unpublishAsset', 'archiveEntry', 'archiveAsset', 'unarchiveEntry', 'unarchiveAsset', 'processAsset'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	function createDialogs(channel) {
	  return {
	  ...
	  function call(entityType, multiple, options) {
	    options = (0, _objectAssign2.default)({}, options, { entityType: entityType, multiple: multiple });
